...
public interface ReservationRepository extends JpaRepository<Reservation, Long>, QuerydslPredicateExecutor<Reservation>, SearchBoardRepository {
    ...
    @Query("select count(r) > 0 from Reservation r where r.regName = :name and r.tel = :tel")
    Boolean isReservationsByRegNameAndTel(@Param("name") String paramString1, @Param("tel") String paramString2);
